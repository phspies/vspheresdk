...
{
    public class ResourceTypesModule
    {
        ...
        public ResourceTypesModule(RestClient Client, CancellationToken _cancellationToken, int _timeout, int _retry)
        {
            restClient = Client;
            retry = _retry;
            timeout = _timeout;
        ...
        public async Task<List<VstatsResourceTypesSummaryType>> ListAsync()
        {
            StringBuilder ListServiceURL = new StringBuilder("/api/stats/rsrc-types");
            ...
            RestResponse<List<VstatsResourceTypesSummaryType>> response = await restClient.ExecuteTaskAsyncWithPolicy<List<VstatsResourceTypesSummaryType>>(request, cancellationToken, timeout, retry);
