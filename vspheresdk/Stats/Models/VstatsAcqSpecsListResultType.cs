...
{
    public class VstatsAcqSpecsListResultType 
    {
        /// <summary>
        /// List of acquisition specifications received. Warning: This attribute is available as Technology Preview. These are early
        ...
        /// </summary>
        /// </summary>
        [JsonProperty(PropertyName = "acq_specs", Required = Required.AllowNull)]
        public Dictionary<string,VstatsAcqSpecsInfoType> AcqSpecs { get; set; }
        /// <summary>
        /// The AcqSpecs.ListResult.next field is a token used to retrieve paged data for larger result sets. This is opaque token
        /// generated by the server. It is to be sent in the AcqSpecs.FilterSpec.page field to issue a subsequent call to the list
