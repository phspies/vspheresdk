...
{
    public class VstatsResourceAddressSchemasInfoType 
    {
        /// <summary>
        ...
        /// <summary>
        /// List of ResourceAddressSchemas.ResourceIdDefinitions. Warning: This attribute is available as Technology Preview. These
        ...
        /// </summary>
        /// </summary>
        [JsonProperty(PropertyName = "schema", Required = Required.AllowNull)]
        public Dictionary<string,VstatsResourceAddressSchemasResourceIdDefinitionType> Schema { get; set; }
    }
}
