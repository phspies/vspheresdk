...
{
    public class NamespaceManagementClusterSizeInfoModule
    {
        ...
        public NamespaceManagementClusterSizeInfoModule(RestClient Client, CancellationToken _cancellationToken, int _timeout, int _retry)
        {
            restClient = Client;
            retry = _retry;
            timeout = _timeout;
        ...
        {
            StringBuilder GetServiceURL = new StringBuilder("/api/vcenter/namespace-management/cluster-size-info");
