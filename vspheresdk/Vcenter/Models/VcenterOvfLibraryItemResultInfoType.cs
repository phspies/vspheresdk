...
{
    public class VcenterOvfLibraryItemResultInfoType 
    {
        /// <summary>
        ...
        public Dictionary<string,VcenterOvfOvfErrorType> Errors { get; set; }
        /// <summary>
        ...
        public Dictionary<string,VcenterOvfOvfWarningType> Warnings { get; set; }
        /// <summary>
        ...
        public Dictionary<string,VcenterOvfOvfInfoType> Information { get; set; }
    }
}
