...
{
    public class VcenterVmStoragePolicyComplianceVmComplianceInfoType 
    {
        /// <summary>
        ...
        public VcenterVmStoragePolicyComplianceStatusEnumType Status { get; set; }
        /// <summary>
        ...
        public Dictionary<string,VapiStdLocalizableMessageType> FailureCause { get; set; }
    }
}
