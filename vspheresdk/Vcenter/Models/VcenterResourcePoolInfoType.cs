...
{
    public class VcenterResourcePoolInfoType 
    {
        /// <summary>
        ...
        public VcenterResourcePoolResourceAllocationInfoType CpuAllocation { get; set; }
        /// <summary>
        ...
        public VcenterResourcePoolResourceAllocationInfoType MemoryAllocation { get; set; }
    }
}
