...
{
    public class VcenterVchaClusterErrorConditionTypeA 
    {
        /// <summary>
        ...
        public VapiStdLocalizableMessageTypeA Error { get; set; }
        /// <summary>
        ...
        public VapiStdLocalizableMessageTypeA Recommendation { get; set; }
    }
}
