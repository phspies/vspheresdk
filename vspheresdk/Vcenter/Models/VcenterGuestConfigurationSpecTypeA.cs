...
{
    public class VcenterGuestConfigurationSpecTypeA 
    {
        /// <summary>
        ...
        public VcenterGuestWindowsConfigurationTypeA WindowsConfig { get; set; }
        /// <summary>
        ...
        public VcenterGuestLinuxConfigurationTypeA LinuxConfig { get; set; }
        /// <summary>
        ...
        public VcenterGuestCloudConfigurationTypeA CloudConfig { get; set; }
    }
}
