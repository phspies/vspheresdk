...
{
    public class VcenterVmTemplateLibraryItemsDeploySpecVmHomeStorageTypeA 
    {
        /// <summary>
        ...
        public VcenterVmTemplateLibraryItemsDeploySpecVmHomeStoragePolicyTypeA StoragePolicy { get; set; }
    }
}
