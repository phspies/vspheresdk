...
{
    public class VcenterVmHardwareDiskInfoType 
    {
        /// <summary>
        /// Device label.
        /// </summary>
        ...
        public VcenterVmHardwareScsiAddressInfoType Scsi { get; set; }
        /// <summary>
        ...
        public VcenterVmHardwareNvmeAddressInfoType Nvme { get; set; }
        /// <summary>
        /// Physical resource backing for the virtual disk.
        /// </summary>
        /// </summary>
        [JsonProperty(PropertyName = "backing", Required = Required.AllowNull)]
        public VcenterVmHardwareDiskBackingInfoType Backing { get; set; }
        /// <summary>
