...
{
    public class VcenterOvfLibraryItemDeploymentResultTypeA 
    {
        /// <summary>
        ...
        public VcenterOvfLibraryItemDeployableIdentityTypeA ResourceId { get; set; }
        /// <summary>
        /// Errors, warnings, and informational messages produced by the {@name LibraryItem#deploy} {@term operation}.
        /// </summary>
        /// </summary>
        [JsonProperty(PropertyName = "error")]
        public VcenterOvfLibraryItemResultInfoTypeA Error { get; set; }
    }
}
