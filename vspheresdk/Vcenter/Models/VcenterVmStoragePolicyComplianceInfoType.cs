...
{
    public class VcenterVmStoragePolicyComplianceInfoType 
    {
        /// <summary>
        ...
        public VcenterVmStoragePolicyComplianceStatusEnumType OverallCompliance { get; set; }
        /// <summary>
        ...
        public VcenterVmStoragePolicyComplianceVmComplianceInfoType VmHome { get; set; }
        /// <summary>
        ...
        public Dictionary<string,VcenterVmStoragePolicyComplianceVmComplianceInfoType> Disks { get; set; }
    }
}
