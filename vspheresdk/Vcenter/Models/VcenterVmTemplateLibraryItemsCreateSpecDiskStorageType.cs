...
{
    public class VcenterVmTemplateLibraryItemsCreateSpecDiskStorageType 
    {
        /// <summary>
        ...
        public VcenterVmTemplateLibraryItemsCreateSpecDiskStoragePolicyType StoragePolicy { get; set; }
    }
}
