...
{
    public class VcenterVchaClusterWitnessCheckResultTypeA 
    {
        /// <summary>
        ...
        public Dictionary<string,VapiStdLocalizableMessageTypeA> Warnings { get; set; }
        /// <summary>
        ...
        public Dictionary<string,VapiStdLocalizableMessageTypeA> Errors { get; set; }
    }
}
