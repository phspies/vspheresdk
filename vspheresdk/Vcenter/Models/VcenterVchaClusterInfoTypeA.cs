...
{
    public class VcenterVchaClusterInfoTypeA 
    {
        /// <summary>
        ...
        public VcenterVchaClusterConfigStateEnumTypeA ConfigState { get; set; }
        /// <summary>
        ...
        public VcenterVchaClusterNodeInfoTypeA Node1 { get; set; }
        /// <summary>
        /// Node configuration information for the VCHA cluster.
        ...
        public VcenterVchaClusterNodeInfoTypeA Node2 { get; set; }
        /// <summary>
        /// Node configuration information for the VCHA cluster.
        /// If unset, then the information is unavailable or the node is not cloned yet.
        /// </summary>
        ...
        public VcenterVchaClusterWitnessInfoTypeA Witness { get; set; }
        /// <summary>
        ...
        public VcenterVchaClusterClusterModeEnumTypeA Mode { get; set; }
        /// <summary>
        ...
        public VcenterVchaClusterClusterStateEnumTypeA HealthState { get; set; }
        /// <summary>
        ...
        public Dictionary<string,VapiStdLocalizableMessageTypeA> HealthException { get; set; }
        /// <summary>
        ...
        public Dictionary<string,VcenterVchaClusterErrorConditionTypeA> HealthWarnings { get; set; }
        /// <summary>
