...
{
    public class VcenterGuestCustomizationSpecType 
    {
        /// <summary>
        ...
        public VcenterGuestConfigurationSpecType ConfigurationSpec { get; set; }
        /// <summary>
        ...
        public VcenterGuestGlobalDnssettingsType GlobalDnssettings { get; set; }
        /// <summary>
        ...
        public Dictionary<string,VcenterGuestAdapterMappingType> Interfaces { get; set; }
    }
}
