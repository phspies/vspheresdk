...
{
    public class VcenterNamespaceManagementSupervisorServicesClusterSupervisorServicesCreateSpecType 
    {
        /// <summary>
        ...
        /// <summary>
        /// A generic key-value map for additional configuration parameters required during service creation. As an example, a third
        ...
        /// If unset, no additional configuration parameters will be applied when installing a Supervisor Service in the vSphere
        /// Supervisor cluster.
        /// </summary>
        /// </summary>
