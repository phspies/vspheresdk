...
{
    public class VcenterVmGuestNetworkingInterfacesIpConfigInfoType 
    {
        /// <summary>
        ...
        public Dictionary<string,VcenterVmGuestNetworkingInterfacesIpAddressInfoType> IpAddresses { get; set; }
        /// <summary>
        ...
        public VcenterVmGuestDhcpConfigInfoType Dhcp { get; set; }
    }
}
