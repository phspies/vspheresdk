...
{
    public class VcenterDeploymentImportHistoryInfoTypeA 
    {
        /// <summary>
        /// The progress info of this task.
        /// This field is optional and it is only relevant when the value of CommonInfo#status is one of RUNNING, FAILED, BLOCKED,
        /// or SUCCEEDED.
        /// </summary>
        /// </summary>
        ...
        /// cis.task.CommonInfo#status has the value SUCCEEDED. The value could change as the operation progresses.
        /// This field will be unset if result is not available at the current step of the operation.
        /// </summary>
        /// </summary>
        [JsonProperty(PropertyName = "result")]
        public VcenterDeploymentNotificationsTypeA Result { get; set; }
        /// <summary>
