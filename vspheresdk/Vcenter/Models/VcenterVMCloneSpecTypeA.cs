...
{
    public class VcenterVMCloneSpecTypeA 
    {
        /// <summary>
        ...
        public VcenterVMClonePlacementSpecTypeA Placement { get; set; }
        /// <summary>
        ...
        public VcenterVMGuestCustomizationSpecTypeA GuestCustomizationSpec { get; set; }
    }
}
