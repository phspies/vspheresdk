...
{
    public class VcenterVmTemplateLibraryItemsCreateSpecVmHomeStorageType 
    {
        /// <summary>
        ...
        public VcenterVmTemplateLibraryItemsCreateSpecVmHomeStoragePolicyType StoragePolicy { get; set; }
    }
}
