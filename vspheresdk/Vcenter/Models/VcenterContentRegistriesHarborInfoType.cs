...
{
    public class VcenterContentRegistriesHarborInfoType 
    {
        /// <summary>
        ...
        public Dictionary<string,VcenterContentRegistriesHarborStorageInfoType> Storage { get; set; }
        /// <summary>
        /// Health status of the container registry.
        /// </summary>
        /// </summary>
        [JsonProperty(PropertyName = "health", Required = Required.AllowNull)]
        public VcenterContentRegistriesHealthInfoType Health { get; set; }
    }
}
