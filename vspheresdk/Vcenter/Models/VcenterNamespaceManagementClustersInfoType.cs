...
namespace vspheresdk.Vcenter.Models
{
    public class VcenterNamespaceManagementClustersInfoType 
    {
        ...
        /// If unset, it means the file volume support is not enabled on this Supervisor Cluster.
        /// </summary>
        /// </summary>
        ...
        /// <summary>
        /// Proxy configuration that is applied to the Supervisor Cluster. The proxy should be reachable from the management network
        /// and is used for image pulling and container traffic exiting out of the Supervisor Cluster.
