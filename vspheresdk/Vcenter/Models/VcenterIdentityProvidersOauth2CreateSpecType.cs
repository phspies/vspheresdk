...
{
    public class VcenterIdentityProvidersOauth2CreateSpecType 
    {
        /// <summary>
        ...
        public VcenterIdentityProvidersOauth2AuthenticationMethodEnumType AuthenticationMethod { get; set; }
        /// <summary>
        /// 
