...
{
    public class VcenterResourcePoolUpdateSpecTypeA 
    {
        /// <summary>
        ...
        public VcenterResourcePoolResourceAllocationUpdateSpecTypeA CpuAllocation { get; set; }
        /// <summary>
        ...
        public VcenterResourcePoolResourceAllocationUpdateSpecTypeA MemoryAllocation { get; set; }
    }
}
