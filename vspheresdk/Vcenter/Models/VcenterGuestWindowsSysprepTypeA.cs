...
{
    public class VcenterGuestWindowsSysprepTypeA 
    {
        /// <summary>
        ...
        public VcenterGuestUserDataTypeA UserData { get; set; }
        /// <summary>
