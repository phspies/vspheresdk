...
{
    public class VcenterVmTemplateLibraryItemsDeployPlacementSpecTypeA 
    {
        /// <summary>
        ...
        /// <summary>
        /// Cluster onto which the deployed virtual machine should be placed. If {@name #cluster} and {@name #resourcePool} are both
