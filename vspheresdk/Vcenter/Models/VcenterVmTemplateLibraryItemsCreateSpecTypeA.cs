...
{
    public class VcenterVmTemplateLibraryItemsCreateSpecTypeA 
    {
        /// <summary>
        ...
        public VcenterVmTemplateLibraryItemsCreateSpecVmHomeStorageTypeA VmHomeStorage { get; set; }
        /// <summary>
        /// Storage specification for the virtual machine template's disks.
        /// </summary>
        /// </summary>
        [JsonProperty(PropertyName = "disk_storage")]
        public VcenterVmTemplateLibraryItemsCreateSpecDiskStorageTypeA DiskStorage { get; set; }
        /// <summary>
        ...
        public VcenterVmTemplateLibraryItemsCreatePlacementSpecTypeA Placement { get; set; }
    }
}
