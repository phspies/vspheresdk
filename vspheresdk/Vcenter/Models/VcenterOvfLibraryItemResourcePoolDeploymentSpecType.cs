...
{
    public class VcenterOvfLibraryItemResourcePoolDeploymentSpecType 
    {
        /// <summary>
        ...
        public object NetworkMappings { get; set; }
        /// <summary>
        ...
        public Dictionary<string,VcenterOvfLibraryItemStorageGroupMappingType>? StorageMappings { get; set; }
        /// <summary>
