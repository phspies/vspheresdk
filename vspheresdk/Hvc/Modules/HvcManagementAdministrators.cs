...
{
    public class HvcManagementAdministratorsModule
    {
        ...
        public HvcManagementAdministratorsModule(RestClient Client, CancellationToken _cancellationToken, int _timeout, int _retry)
        {
            restClient = Client;
            retry = _retry;
            timeout = _timeout;
        ...
        public async Task SetAsync(VcenterHvcManagementAdministratorsSetType RequestBody)
        {
            ArgumentNullException.ThrowIfNull(RequestBody, "RequestBody cannot be null");
            StringBuilder SetServiceURL = new StringBuilder("/api/hvc/management/administrators");
        ...
        {
            StringBuilder GetServiceURL = new StringBuilder("/api/hvc/management/administrators");
            var request = new RestRequest
            {              
                RequestFormat = DataFormat.Json,
                Method = Method.Get
        ...
        public async Task AddAsync(VcenterHvcManagementAdministratorsAddType RequestBody)
        {
            ArgumentNullException.ThrowIfNull(RequestBody, "RequestBody cannot be null");
            StringBuilder AddServiceURL = new StringBuilder("/api/hvc/management/administrators?action=add");
            var request = new RestRequest
            {              
                RequestFormat = DataFormat.Json,
                Method = Method.Post
        ...
        public async Task RemoveAsync(VcenterHvcManagementAdministratorsRemoveType RequestBody)
        {
            ArgumentNullException.ThrowIfNull(RequestBody, "RequestBody cannot be null");
            StringBuilder RemoveServiceURL = new StringBuilder("/api/hvc/management/administrators?action=remove");
            var request = new RestRequest
            {              
                RequestFormat = DataFormat.Json,
                Method = Method.Post
