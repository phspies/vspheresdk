...
{
    public class AccessConsolecliModule
    {
        ...
        public AccessConsolecliModule(RestClient Client, CancellationToken _cancellationToken, int _timeout, int _retry)
        {
            restClient = Client;
            retry = _retry;
            timeout = _timeout;
        ...
        public async Task SetAsync(ApplianceAccessConsolecliSetType RequestBody)
        {
            ArgumentNullException.ThrowIfNull(RequestBody, "RequestBody cannot be null");
            StringBuilder SetServiceURL = new StringBuilder("/api/appliance/access/consolecli");
        ...
        {
            StringBuilder GetServiceURL = new StringBuilder("/api/appliance/access/consolecli");
            var request = new RestRequest
            {              
                RequestFormat = DataFormat.Json,
                Method = Method.Get
