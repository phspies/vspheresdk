...
{
    public class UpdatePolicyModule
    {
        ...
        public UpdatePolicyModule(RestClient Client, CancellationToken _cancellationToken, int _timeout, int _retry)
        {
            restClient = Client;
            retry = _retry;
            timeout = _timeout;
        ...
        public async Task SetAsync(ApplianceUpdatePolicyConfigType RequestBody = null)
        {
            StringBuilder SetServiceURL = new StringBuilder("/api/appliance/update/policy");
        ...
        public async Task<ApplianceUpdatePolicyInfoType> GetAsync()
        {
            StringBuilder GetServiceURL = new StringBuilder("/api/appliance/update/policy");
            var request = new RestRequest
            {              
                RequestFormat = DataFormat.Json,
                Method = Method.Get
            ...
            RestResponse<ApplianceUpdatePolicyInfoType> response = await restClient.ExecuteTaskAsyncWithPolicy<ApplianceUpdatePolicyInfoType>(request, cancellationToken, timeout, retry);
