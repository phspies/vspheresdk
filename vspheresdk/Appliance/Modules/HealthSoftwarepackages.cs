...
namespace vspheresdk.Appliance.Modules
{
    public class HealthSoftwarepackagesModule
    {
        ...
        public async Task<ApplianceHealthSoftwarepackagesHealthLevelType> GetAsync()
        {
            ...
            RestResponse<ApplianceHealthSoftwarepackagesHealthLevelType> response = await restClient.ExecuteTaskAsyncWithPolicy<ApplianceHealthSoftwarepackagesHealthLevelType>(request, cancellationToken, timeout, retry);
