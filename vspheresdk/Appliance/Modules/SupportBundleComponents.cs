...
{
    public class SupportBundleComponentsModule
    {
        ...
        public SupportBundleComponentsModule(RestClient Client, CancellationToken _cancellationToken, int _timeout, int _retry)
        {
            restClient = Client;
            retry = _retry;
            timeout = _timeout;
        ...
        {
            StringBuilder GetServiceURL = new StringBuilder("/api/appliance/support-bundle/components");
