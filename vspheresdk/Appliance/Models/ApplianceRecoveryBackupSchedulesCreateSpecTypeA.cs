...
{
    public class ApplianceRecoveryBackupSchedulesCreateSpecTypeA 
    {
        /// <summary>
        /// List of optional parts to be backed up. Use the Parts.list operation to get information about the supported parts.
        ...
        /// If unset backup job will not be scheduled. See Schedules.RecurrenceInfo
        /// </summary>
        /// </summary>
        [JsonProperty(PropertyName = "recurrence_info")]
        public ApplianceRecoveryBackupSchedulesRecurrenceInfoTypeA RecurrenceInfo { get; set; }
        /// <summary>
        /// Retention information for the schedule.
        /// If unset all the completed backup jobs will be retained forever. See Schedules.RetentionInfo
        /// </summary>
        /// </summary>
        [JsonProperty(PropertyName = "retention_info")]
        public ApplianceRecoveryBackupSchedulesRetentionInfoTypeA RetentionInfo { get; set; }
    }
}
