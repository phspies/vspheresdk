...
{
    public class ApplianceVcenterSettingsV1ConfigCheckSpecType 
    {
        /// <summary>
        /// Message to include with the check. Warning: This attribute is available as Technology Preview. These are early access
