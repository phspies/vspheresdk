...
{
    public class ApplianceVcenterSettingsV1ConfigCheckDesiredStateTaskType 
    {
        /// <summary>
        ...
        /// <summary>
        /// checkSpec to include a message with the apply. Warning: This attribute is available as Technology Preview. These are
        ...
        /// </summary>
        /// </summary>
        [JsonProperty(PropertyName = "check_spec", Required = Required.AllowNull)]
        public ApplianceVcenterSettingsV1ConfigCheckSpecType CheckSpec { get; set; }
    }
}
