...
{
    public class ApplianceVcenterSettingsV1ConfigApplySpecType 
    {
        /// <summary>
        /// Message to include with the apply. Warning: This attribute is available as Technology Preview. These are early access
