...
{
    public class ApplianceRecoveryBackupPartsPartTypeA 
    {
        /// <summary>
        /// part ID
        ...
        public ApplianceRecoveryBackupPartsLocalizableMessageTypeA Name { get; set; }
        /// <summary>
        /// part description id in message bundle
        /// </summary>
        /// </summary>
        [JsonProperty(PropertyName = "description", Required = Required.AllowNull)]
        public ApplianceRecoveryBackupPartsLocalizableMessageTypeA Description { get; set; }
        /// <summary>
