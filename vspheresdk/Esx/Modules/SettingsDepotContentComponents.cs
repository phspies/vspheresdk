...
{
    public class SettingsDepotContentComponentsModule
    {
        ...
        public SettingsDepotContentComponentsModule(RestClient Client, CancellationToken _cancellationToken, int _timeout, int _retry)
        {
            restClient = Client;
            retry = _retry;
            timeout = _timeout;
        ...
        public async Task<List<EsxSettingsDepotContentComponentsSummaryType>> ListAsync(string Vendors = null, string Names = null, string Versions = null, string? MinVersion = null, string BundleTypes = null)
        {
            StringBuilder ListServiceURL = new StringBuilder("/api/esx/settings/depot-content/components");
            ...
            if (BundleTypes != null) { request.AddQueryParameter("bundle_types", BundleTypes.ToString()); }
            request.Resource = ListServiceURL.ToString();
            RestResponse<List<EsxSettingsDepotContentComponentsSummaryType>> response = await restClient.ExecuteTaskAsyncWithPolicy<List<EsxSettingsDepotContentComponentsSummaryType>>(request, cancellationToken, timeout, retry);
