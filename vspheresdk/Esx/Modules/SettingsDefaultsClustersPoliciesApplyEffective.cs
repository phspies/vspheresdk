...
{
    public class SettingsDefaultsClustersPoliciesApplyEffectiveModule
    {
        ...
        public SettingsDefaultsClustersPoliciesApplyEffectiveModule(RestClient Client, CancellationToken _cancellationToken, int _timeout, int _retry)
        {
            restClient = Client;
            retry = _retry;
            timeout = _timeout;
        ...
        public async Task<EsxSettingsDefaultsClustersPoliciesApplyEffectiveEffectivePolicySpecType> GetAsync()
        {
            StringBuilder GetServiceURL = new StringBuilder("/api/esx/settings/defaults/clusters/policies/apply/effective");
            ...
            RestResponse<EsxSettingsDefaultsClustersPoliciesApplyEffectiveEffectivePolicySpecType> response = await restClient.ExecuteTaskAsyncWithPolicy<EsxSettingsDefaultsClustersPoliciesApplyEffectiveEffectivePolicySpecType>(request, cancellationToken, timeout, retry);
