...
{
    public class SettingsDepotsOfflineContentModule
    {
        ...
        public SettingsDepotsOfflineContentModule(RestClient Client, CancellationToken _cancellationToken, int _timeout, int _retry)
        {
            restClient = Client;
            retry = _retry;
            timeout = _timeout;
        ...
        public async Task<EsxSettingsDepotsOfflineContentInfoType> GetAsync(string Depot)
        {
            ArgumentNullException.ThrowIfNull(Depot, "Depot cannot be null");
            StringBuilder GetServiceURL = new StringBuilder("/api/esx/settings/depots/offline/{depot}/content");
            ...
            RestResponse<EsxSettingsDepotsOfflineContentInfoType> response = await restClient.ExecuteTaskAsyncWithPolicy<EsxSettingsDepotsOfflineContentInfoType>(request, cancellationToken, timeout, retry);
