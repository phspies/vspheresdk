...
{
    public class SettingsClustersSoftwareDraftsSoftwareEffectiveComponentsModule
    {
        ...
        public SettingsClustersSoftwareDraftsSoftwareEffectiveComponentsModule(RestClient Client, CancellationToken _cancellationToken, int _timeout, int _retry)
        {
            restClient = Client;
            retry = _retry;
            timeout = _timeout;
        ...
        public async Task<object> ListAsync(string Cluster, string Draft)
        {
            ...
            StringBuilder ListServiceURL = new StringBuilder("/api/esx/settings/clusters/{cluster}/software/drafts/{draft}/software/effective-components");
