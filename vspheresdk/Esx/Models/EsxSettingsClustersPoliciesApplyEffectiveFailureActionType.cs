...
{
    public class EsxSettingsClustersPoliciesApplyEffectiveFailureActionType 
    {
        /// <summary>
        ...
        public EsxSettingsClustersPoliciesApplyEffectiveFailureActionActionEnumType Action { get; set; }
        /// <summary>
