...
{
    public class EsxSettingsHardwareSupportManagersPackagesFilterSpecType 
    {
        /// <summary>
        /// vSphere release version the Hardware Support Package (HSP) must support to match the filter. Only Hardware Support
        ...
        /// "7.1.0-1.0.355667" but not "7.1.0-3.0.63445" or any base image version starting with "7.2". Note that we require
