...
{
    public class EsxSettingsHardwareSupportManagersPackagesVersionsPackageInfoType 
    {
        /// <summary>
        ...
        public Dictionary<string,EsxSettingsHardwareSupportManagersPackagesVersionsComponentInfoType> Components { get; set; }
        /// <summary>
        /// List of components removed by this HSP manifest.
        /// </summary>
        /// </summary>
        [JsonProperty(PropertyName = "removed_components", Required = Required.AllowNull)]
        public Dictionary<string,EsxSettingsHardwareSupportManagersPackagesVersionsRemovedComponentInfoType> RemovedComponents { get; set; }
    }
}
