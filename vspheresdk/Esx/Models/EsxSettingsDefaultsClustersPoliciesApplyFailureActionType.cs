...
{
    public class EsxSettingsDefaultsClustersPoliciesApplyFailureActionType 
    {
        /// <summary>
        ...
        public EsxSettingsDefaultsClustersPoliciesApplyFailureActionActionEnumType Action { get; set; }
        /// <summary>
