...
{
    public class VapiMetadataCliCommandInfoTypeA 
    {
        /// <summary>
        ...
        public Dictionary<string,VapiMetadataCliCommandOptionInfoTypeA> Options { get; set; }
        /// <summary>
        /// The formatter to use when displaying the output of this command.
        /// </summary>
        /// </summary>
        [JsonProperty(PropertyName = "formatter")]
        public VapiMetadataCliCommandFormatterTypeEnumA Formatter { get; set; }
        /// <summary>
        ...
        public Dictionary<string,VapiMetadataCliCommandOutputInfoTypeA> OutputFieldList { get; set; }
    }
}
