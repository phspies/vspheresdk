...
{
    public class VapiMetadataMetamodelOperationInfoType 
    {
        /// <summary>
        ...
        public Dictionary<string,VapiMetadataMetamodelFieldInfoType> Params { get; set; }
        /// <summary>
        /// Metamodel type for the output element.
        /// </summary>
        /// </summary>
        [JsonProperty(PropertyName = "output", Required = Required.AllowNull)]
        public VapiMetadataMetamodelOperationResultInfoType Output { get; set; }
        /// <summary>
        ...
        public Dictionary<string,VapiMetadataMetamodelErrorInfoType> Errors { get; set; }
        /// <summary>
