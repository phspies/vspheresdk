...
{
    public class VapiMetadataMetamodelServiceInfoType 
    {
        /// <summary>
        ...
        public Dictionary<string,VapiMetadataMetamodelOperationInfoType> Operations { get; set; }
        /// <summary>
        ...
        public Dictionary<string,VapiMetadataMetamodelConstantInfoType> Constants { get; set; }
        /// <summary>
