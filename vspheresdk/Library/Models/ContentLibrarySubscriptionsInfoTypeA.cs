...
{
    public class ContentLibrarySubscriptionsInfoTypeA 
    {
        /// <summary>
        ...
        public ContentLibrarySubscriptionsLocationEnumTypeA SubscribedLibraryLocation { get; set; }
        /// <summary>
        ...
        public ContentLibrarySubscriptionsVcenterInfoTypeA SubscribedLibraryVcenter { get; set; }
        /// <summary>
        ...
        public ContentLibrarySubscriptionsPlacementInfoTypeA SubscribedLibraryPlacement { get; set; }
    }
}
