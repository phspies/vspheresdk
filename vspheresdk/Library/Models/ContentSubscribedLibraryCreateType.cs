...
{
    public class ContentSubscribedLibraryCreateType 
    {
        /// <summary>
        ...
        public ContentLibraryModelLibraryTypeEnum Type { get; set; }
        /// <summary>
        ...
        public ContentLibraryOptimizationInfoType OptimizationInfo { get; set; }
        /// <summary>
        ...
        public ContentLibraryPublishInfoType PublishInfo { get; set; }
        /// <summary>
