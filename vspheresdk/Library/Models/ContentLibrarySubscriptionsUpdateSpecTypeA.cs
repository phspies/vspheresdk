...
{
    public class ContentLibrarySubscriptionsUpdateSpecTypeA 
    {
        /// <summary>
        ...
        public ContentLibrarySubscriptionsUpdateSpecVcenterTypeA SubscribedLibraryVcenter { get; set; }
        /// <summary>
        ...
        public ContentLibrarySubscriptionsUpdateSpecPlacementTypeA SubscribedLibraryPlacement { get; set; }
    }
}
