...
{
    public class ContentLibrarySubscriptionInfoType 
    {
        /// <summary>
        ...
        public ContentLibrarySubscriptionInfoAuthenticationMethodEnumType AuthenticationMethod { get; set; }
        /// <summary>
        ...
        public ContentLibrarySourceInfoType SourceInfo { get; set; }
    }
}
