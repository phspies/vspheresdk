...
{
    public class ContentLibraryItemUpdateSessionCreateTypeA 
    {
        /// <summary>
        /// Unique token generated by the client for each creation request. The token should be a universally unique identifier
        ...
        public ContentLibraryItemUpdateSessionModelTypeA CreateSpec { get; set; }
    }
}
