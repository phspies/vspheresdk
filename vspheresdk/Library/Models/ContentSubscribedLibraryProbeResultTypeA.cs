...
{
    public class ContentSubscribedLibraryProbeResultTypeA 
    {
        /// <summary>
        ...
        public ContentSubscribedLibraryProbeResultStatusEnumTypeA Status { get; set; }
        /// <summary>
        ...
        public Dictionary<string,VapiStdLocalizableMessageTypeA> ErrorMessages { get; set; }
    }
}
