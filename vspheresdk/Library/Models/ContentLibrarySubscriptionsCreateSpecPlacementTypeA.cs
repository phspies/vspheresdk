...
{
    public class ContentLibrarySubscriptionsCreateSpecPlacementTypeA 
    {
        /// <summary>
        ...
        /// <summary>
        /// Resource pool into which the virtual machine template should be placed. If {@name #host} and {@name #resourcePool} are
        /// both specified, {@name #resourcePool} must belong to {@name #host}. If {@name #cluster} and {@name #resourcePool} are
        /// both specified, {@name #resourcePool} must belong to {@name #cluster}.
        /// </summary>
        /// </summary>
