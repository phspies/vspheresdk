...
{
    public class ContentLibraryItemDownloadSessionCreateTypeA 
    {
        /// <summary>
        /// A unique token generated by the client for each creation request. The token should be a universally unique identifier
        ...
        public ContentLibraryItemDownloadSessionModelTypeA CreateSpec { get; set; }
    }
}
