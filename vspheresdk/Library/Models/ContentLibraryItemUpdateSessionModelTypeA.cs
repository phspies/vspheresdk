...
{
    public class ContentLibraryItemUpdateSessionModelTypeA 
    {
        /// <summary>
        ...
        public ContentLibraryItemUpdatesessionPreviewInfoTypeA PreviewInfo { get; set; }
        /// <summary>
        ...
        public Dictionary<string,ContentLibraryItemUpdatesessionWarningBehaviorTypeA> WarningBehavior { get; set; }
    }
}
