...
{
    public class ContentLibraryItemUpdatesessionFileValidationResultType 
    {
        /// <summary>
        ...
        public Dictionary<string,ContentLibraryItemUpdatesessionFileValidationErrorType> InvalidFiles { get; set; }
    }
}
